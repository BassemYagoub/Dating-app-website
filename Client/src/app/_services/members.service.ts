...
export class MembersService {
  ...
  userParams: WritableSignal<UserParams> = signal<UserParams>(new UserParams(this.user));

  resetUserParams() {
    this.userParams.set(new UserParams(this.user));
  }

  getMembers(): Subscription | void {
...
function model<T>(arg0: UserParams): UserParams {
